...
namespace {
    ...
    class Input extends \Illuminate\Support\Facades\Input{
         ...
         * 
         * Suppose that an index1.blade.php file instantiates this request object:
         * 
         *  * http://localhost/index1.blade.php         returns an empty string
         *  * http://localhost/index1.blade.php/page    returns an empty string
         *  * http://localhost/web/index1.blade.php     returns '/web'
         *  * http://localhost/we%20b/index1.blade.php  returns '/we%20b'
         *
         * @return string The raw path (i.e. not urldecoded)
         * @api 
         * @static 
         ...
         * script filename (e.g. index1.blade.php) if one exists.
         *
